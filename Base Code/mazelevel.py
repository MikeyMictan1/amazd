...
class MazeLevel:
    def __init__(self, maze_list):
        ...
        self.game_over = GameOver(self.character)
    ...
    def check_game_over(self):
        if self.character.health <= 0 or self.character.points <= 0:  # causes game over screen, and checks if the user has gone to the menu from it
            self.game_over.run()
