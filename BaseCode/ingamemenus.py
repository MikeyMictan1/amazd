...
class InGameMenu(GameChange):
    def __init__(self):
        ...
        self.__in_game_menu_graphics_dict = import_graphics_dict("ingamemenu", self.__in_game_menu_graphics_dict, "../Graphics")

        self.__menu_txt_pos = (img_centre(self.menu_txt_white)[0], screen_height // 2.6)
        self.__menu_option = OptionPress(self.menu_txt_white, self.menu_txt_yellow, self.__menu_txt_pos)
        self.__quit_txt_pos = (img_centre(self.quit_txt_white)[0], screen_height // 1.3)
        ...
        self.__continue_txt_pos = (img_centre(self.__continue_txt_white)[0], screen_height // 1.75)
        self.__continue_option = OptionPress(self.__continue_txt_white, self.__continue_txt_yellow, self.__continue_txt_pos)
        ...
        self.__in_game_menu_txt = font.render("IN-GAME MENU", 1, white)
    ...
    def display_menu(self):
        ...
        self.screen.blit(self.__in_game_menu_txt, (img_centre(self.__in_game_menu_txt)[0], screen_height // 10))
...
class ControlsMenu(InGameMenu):
    ...
    def display_menu(self):
        ...
        self.screen.blit(self.menu_overlay, (img_centre(self.menu_overlay)[0], img_centre(self.menu_overlay)[1]))
        self.screen.blit(self.__control_set_image, (img_centre(self.__control_set_image)[0], img_centre(self.__control_set_image)[1]))
